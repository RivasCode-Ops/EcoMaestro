...
export function buildAplicadores(plan, gh, cat) {
  ...
  const push = (id, principal) => {
    ...
    if (id === 'cursor') {
      href = '../workbench/Projeto Novo/CODING-DIARIO.md';
      note =
        'Abra o repo no Cursor; use D00/D01/D02 do workbench. Copie .cursor/rules de GeoGrowth-Cursor/kit-para-copiar se precisar.';
