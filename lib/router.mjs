...
export function buildAplicadores(plan, gh, cat) {
  ...
  const push = (id, principal) => {
    ...
    if (id === 'cursor') {
      ...
      note =
        'Abra o repo no Cursor; D00/D01/D02 no workbench. Instale rules: workbench/Cursor-Kit/INSTALAR-NO-REPO.bat';
      if (cat && cat.pasta) note += ' Pasta: c:\\_PROJETOS\\' + cat.pasta;
